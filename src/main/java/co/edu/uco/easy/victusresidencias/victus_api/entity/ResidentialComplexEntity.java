...
public class ResidentialComplexEntity extends DomainEntity {
    ...
    private String pagoAdministracion;
    ...
    public ResidentialComplexEntity() {
        ...
        setPagoAdministracion(TextHelper.EMPTY);
    }
    ...
    public String getPagoAdministracion() {
        return pagoAdministracion;
    }
    public void setPagoAdministracion(String pagoAdministracion) {
