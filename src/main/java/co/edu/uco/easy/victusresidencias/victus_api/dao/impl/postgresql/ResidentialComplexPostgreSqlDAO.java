...
final class ResidentialComplexPostgreSqlDAO extends SqlDAO implements ResidentialComplexDAO {
	...
	private static final String SELECT = "SELECT id, nombre, telefono_contacto, direccion, descripcion, correo, ciudad_id, administrador_id, portero_id ,pago_administracion";
	private static final String DELETE = "DELETE FROM conjunto_residencial WHERE id = ?";
	private static final String UPDATE = "UPDATE conjunto_residencial SET nombre = ?, telefono_contacto = ?, direccion = ?, descripcion = ?, correo = ?, ciudad_id = ?, administrador_id = ?, portero_id = ?,pago_administracion = ?  WHERE id = ?";
	...
	private static final String CREATEstatemente = "INSERT INTO conjunto_residencial(id, nombre, telefono_contacto, direccion, descripcion, correo, ciudad_id, administrador_id, portero_id,pago_administracion ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public List<ResidentialComplexEntity> findByFilter(ResidentialComplexEntity filter) {
		...
		try (var preparedStatement = getConnection().prepareStatement(statement.toString())) {
			...
			while (result.next()) {
				...
				residentialComplexEntityTmp.setPagoAdministracion(result.getString("pago_administracion"));
	...
	public void create(ResidentialComplexEntity data) {
		...
		try (final var preparedStatement = getConnection().prepareStatement(statement.toString())) {
			...
			preparedStatement.setString(10, data.getPagoAdministracion());
	...
	public void update(ResidentialComplexEntity data) {
		...
		try (final var preparedStatement = getConnection().prepareStatement(statement.toString())) {
			...
			preparedStatement.setString(9, data.getPagoAdministracion());
			...
			preparedStatement.setObject(10, data.getId());
